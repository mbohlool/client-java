...
//import io.kubernetes.java.apis.BatchV2alpha1Api;
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#createNamespacedJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#deleteCollectionNamespacedJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#deleteNamespacedJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#listJobForAllNamespaces");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#listNamespacedJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#patchNamespacedJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#patchNamespacedJobStatus");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#readNamespacedJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#readNamespacedJobStatus");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#replaceNamespacedJob");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling BatchV2alpha1Api#replaceNamespacedJobStatus");
    e.printStackTrace();
}
```
