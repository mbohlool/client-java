...
/**
 * API tests for Authorization_v1beta1Api
 */
@Ignore
public class Authorization_v1beta1ApiTest {

    private final Authorization_v1beta1Api api = new Authorization_v1beta1Api();
