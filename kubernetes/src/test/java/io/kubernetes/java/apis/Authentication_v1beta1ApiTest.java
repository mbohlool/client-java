...
/**
 * API tests for Authentication_v1beta1Api
 */
@Ignore
public class Authentication_v1beta1ApiTest {

    private final Authentication_v1beta1Api api = new Authentication_v1beta1Api();
