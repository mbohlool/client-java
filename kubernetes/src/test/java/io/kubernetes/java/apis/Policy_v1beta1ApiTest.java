...
/**
 * API tests for Policy_v1beta1Api
 */
@Ignore
public class Policy_v1beta1ApiTest {

    private final Policy_v1beta1Api api = new Policy_v1beta1Api();
    ...
    public void deleteNamespacedPodDisruptionBudgetTest() throws ApiException {
        ...
        UnversionedStatus response = api.deleteNamespacedPodDisruptionBudget(name, namespace, body, pretty, gracePeriodSeconds, orphanDependents);
