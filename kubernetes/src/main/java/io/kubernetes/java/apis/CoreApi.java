...
import io.kubernetes.java.models.UnversionedAPIVersions;
...
public class CoreApi {
     ...
     */
    public UnversionedAPIVersions getAPIVersions() throws ApiException {
        ApiResponse<UnversionedAPIVersions> resp = getAPIVersionsWithHttpInfo();
        return resp.getData();
    }
     ...
     * 
     * get available API versions
     * @return ApiResponse&lt;UnversionedAPIVersions&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UnversionedAPIVersions> getAPIVersionsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getAPIVersionsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<UnversionedAPIVersions>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getAPIVersionsAsync(final ApiCallback<UnversionedAPIVersions> callback) throws ApiException {
