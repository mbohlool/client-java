...
public class ApisApi {
     ...
     */
    public UnversionedAPIGroupList getAPIVersions() throws ApiException {
        ApiResponse<UnversionedAPIGroupList> resp = getAPIVersionsWithHttpInfo();
        return resp.getData();
    }
     ...
     * 
     * get available API versions
     * @return ApiResponse&lt;UnversionedAPIGroupList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UnversionedAPIGroupList> getAPIVersionsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getAPIVersionsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<UnversionedAPIGroupList>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getAPIVersionsAsync(final ApiCallback<UnversionedAPIGroupList> callback) throws ApiException {
