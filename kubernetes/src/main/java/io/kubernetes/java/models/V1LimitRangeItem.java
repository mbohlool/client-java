...
public class V1LimitRangeItem {
  ...
  private Map<String, ResourceQuantity> _default = new HashMap<String, ResourceQuantity>();

  @SerializedName("defaultRequest")
  private Map<String, ResourceQuantity> defaultRequest = new HashMap<String, ResourceQuantity>();

  @SerializedName("max")
  private Map<String, ResourceQuantity> max = new HashMap<String, ResourceQuantity>();

  @SerializedName("maxLimitRequestRatio")
  private Map<String, ResourceQuantity> maxLimitRequestRatio = new HashMap<String, ResourceQuantity>();

  @SerializedName("min")
  private Map<String, ResourceQuantity> min = new HashMap<String, ResourceQuantity>();

  @SerializedName("type")
  private String type = null;

  public V1LimitRangeItem _default(Map<String, ResourceQuantity> _default) {
    this._default = _default;
    return this;
  }

  public V1LimitRangeItem putDefaultItem(String key, ResourceQuantity _defaultItem) {
  ...
  **/
  ...
  public Map<String, ResourceQuantity> getDefault() {
    return _default;
  }

  public void setDefault(Map<String, ResourceQuantity> _default) {
    this._default = _default;
  }

  public V1LimitRangeItem defaultRequest(Map<String, ResourceQuantity> defaultRequest) {
    this.defaultRequest = defaultRequest;
    return this;
  }

  public V1LimitRangeItem putDefaultRequestItem(String key, ResourceQuantity defaultRequestItem) {
  ...
  **/
  ...
  public Map<String, ResourceQuantity> getDefaultRequest() {
    return defaultRequest;
  }

  public void setDefaultRequest(Map<String, ResourceQuantity> defaultRequest) {
    this.defaultRequest = defaultRequest;
  }

  public V1LimitRangeItem max(Map<String, ResourceQuantity> max) {
    this.max = max;
    return this;
  }

  public V1LimitRangeItem putMaxItem(String key, ResourceQuantity maxItem) {
  ...
  **/
  ...
  public Map<String, ResourceQuantity> getMax() {
    return max;
  }

  public void setMax(Map<String, ResourceQuantity> max) {
    this.max = max;
  }

  public V1LimitRangeItem maxLimitRequestRatio(Map<String, ResourceQuantity> maxLimitRequestRatio) {
    this.maxLimitRequestRatio = maxLimitRequestRatio;
    return this;
  }

  public V1LimitRangeItem putMaxLimitRequestRatioItem(String key, ResourceQuantity maxLimitRequestRatioItem) {
  ...
  **/
  ...
  public Map<String, ResourceQuantity> getMaxLimitRequestRatio() {
    return maxLimitRequestRatio;
  }

  public void setMaxLimitRequestRatio(Map<String, ResourceQuantity> maxLimitRequestRatio) {
    this.maxLimitRequestRatio = maxLimitRequestRatio;
  }

  public V1LimitRangeItem min(Map<String, ResourceQuantity> min) {
    this.min = min;
    return this;
  }

  public V1LimitRangeItem putMinItem(String key, ResourceQuantity minItem) {
  ...
  **/
  ...
  public Map<String, ResourceQuantity> getMin() {
    return min;
  }

  public void setMin(Map<String, ResourceQuantity> min) {
    this.min = min;
  }
