...
public class V2alpha1JobCondition {
  ...
  public V2alpha1JobCondition lastProbeTime(UnversionedTime lastProbeTime) {
  ...
  **/
  ...
  public V2alpha1JobCondition lastTransitionTime(UnversionedTime lastTransitionTime) {
