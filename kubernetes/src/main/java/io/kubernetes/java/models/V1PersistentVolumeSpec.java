...
public class V1PersistentVolumeSpec {
  ...
  **/
  ...
  public V1PersistentVolumeSpec capacity(Map<String, ResourceQuantity> capacity) {
    this.capacity = capacity;
    return this;
  }

  public V1PersistentVolumeSpec putCapacityItem(String key, ResourceQuantity capacityItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessModes, awsElasticBlockStore, azureDisk, azureFile, capacity, cephfs, cinder, claimRef, fc, flexVolume, flocker, gcePersistentDisk, glusterfs, hostPath, iscsi, nfs, persistentVolumeReclaimPolicy, photonPersistentDisk, quobyte, rbd, vsphereVolume);
  }
