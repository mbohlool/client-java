...
import io.kubernetes.java.models.V1beta1JobSpec;
import io.kubernetes.java.models.V1beta1JobStatus;
 ...
 */
@ApiModel(description = "Job represents the configuration of a single job. DEPRECATED: extensions/v1beta1.Job is deprecated, use batch/v1.Job instead.")
