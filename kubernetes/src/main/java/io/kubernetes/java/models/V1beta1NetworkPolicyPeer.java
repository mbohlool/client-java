...
public class V1beta1NetworkPolicyPeer {
  ...
  private UnversionedLabelSelector namespaceSelector = null;

  @SerializedName("podSelector")
  private UnversionedLabelSelector podSelector = null;

  public V1beta1NetworkPolicyPeer namespaceSelector(UnversionedLabelSelector namespaceSelector) {
  ...
  **/
  ...
  public UnversionedLabelSelector getNamespaceSelector() {
    return namespaceSelector;
  }

  public void setNamespaceSelector(UnversionedLabelSelector namespaceSelector) {
    this.namespaceSelector = namespaceSelector;
  }

  public V1beta1NetworkPolicyPeer podSelector(UnversionedLabelSelector podSelector) {
